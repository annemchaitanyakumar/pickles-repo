        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/">
              ...
              >
                <img src="/HT_Pickles_gif.gif" alt="Logo" className="h-12 w-auto" />
                <span className="text-lg font-bold gradient-primary bg-clip-text text-transparent">
                  <span className="md:hidden">HT Pickles</span>
                  <span className="hidden md:inline">Homely Taste Pickles</span>
                </span>
              </motion.div>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-6 flex-1 justify-center">
            {navItems.map(item => (
              <Link
                key={item.path}
                to={item.path}
                className={`text-sm font-medium transition-colors hover:text-primary whitespace-nowrap ${location.pathname === item.path ? 'text-primary' : 'text-muted-foreground'}`}
              >
                {item.name}
              </Link>
            ))}
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:block">
              <SearchBar className="w-48 lg:w-60" />
            </div>
